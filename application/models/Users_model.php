...
class Users_model extends Crud_model {
    ...
    function authenticate($email, $password) {
        ...
        if ($result->num_rows() == 1) {
            ...
            if ($user_info->user_type === "client" && get_setting("disable_client_login_and_signup")) {
                return false;
            }
    ...
    function get_access_info($user_id = 0) {
        ...
        $sql = "SELECT $users_table.id, $users_table.user_type, $users_table.is_admin, $users_table.role_id, $users_table.email,
            $users_table.first_name, $users_table.last_name, $users_table.image, $users_table.message_checked_at,  $users_table.client_id, 
