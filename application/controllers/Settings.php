...
class Settings extends Pre_loader {
    ...
    function save_general_settings() {
        $settings = array("site_logo", "invoice_logo", "app_title", "language", "timezone", "date_format", "time_format", "first_day_of_week", "currency_symbol", "decimal_separator", "accepted_file_formats");
