...
class Invoice_payments extends Pre_loader {
    ...
    function credit_card_form() {
        ...
        $view_data['model_info'] = $this->Invoices_model->get_invoice_total_summary($invoice_id);
        $view_data['payment_methods_dropdown'] = $this->Payment_methods_model->get_dropdown_list(array("title"));
        $view_data['invoice_id'] = $invoice_id;
        $this->load->view('invoices/credit_card_modal', $view_data);
    }
