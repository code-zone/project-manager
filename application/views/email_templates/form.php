<div class="panel panel-default">
    ...
    <div class="modal-body clearfix">
        ...
        <div class="form-group m0">
            ...
            <button id="restore_to_default" data-id="<?php echo $model_info->id; ?>" data-placement="top" type="button" class="btn btn-danger"><span class="fa fa-refresh"></span> <?php echo lang('restore_to_default'); ?></button>
        </div>
