        ...
        <tr>
            ...
            <td style="width: 35%;">
                <div style="text-align: right; line-height: 23px;">
                    <span style="font-size:20px; font-weight: bold; background-color: #2AA384; color: #fff;">&nbsp; <span style="text-transform: uppercase;"><?php echo lang("invoice") . " #" . $invoice_info->id; ?></span>&nbsp; </span>
...
<table style="width: 100%; color: #444;">            
    ...
    foreach ($invoice_items as $item) {
        ...
        <tr style="background-color: #f4f4f4; ">
            ...
            <td style="text-align: right; width: 15%; border: 1px solid #fff;"> <?php echo to_currency($item->rate, $item->currency); ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff;"> <?php echo to_currency($item->total, $item->currency); ?></td>
        </tr>
    <?php } ?>
    <tr>
        ...
        <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
            <?php echo to_currency($invoice_total_summary->invoice_subtotal, $invoice_total_summary->currency); ?>
        </td>
    </tr>
    <?php if ($invoice_total_summary->tax) { ?>
        <tr>
            ...
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($invoice_total_summary->tax, $invoice_total_summary->currency); ?>
            </td>
        </tr>
    <?php } ?>
    <?php if ($invoice_total_summary->tax2) { ?>
        <tr>
            ...
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($invoice_total_summary->tax2, $invoice_total_summary->currency); ?>
            </td>
        </tr>
    <?php } ?>
    <?php if ($invoice_total_summary->total_paid) { ?>     
        <tr>
            ...
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
                <?php echo to_currency($invoice_total_summary->total_paid, $invoice_total_summary->currency); ?>
            </td>
        </tr>
    <?php } ?>
    <tr>
