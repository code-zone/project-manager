<div class="page-title clearfix">
    ...
    <div class="title-button-group">
        ...
        <?php echo modal_anchor(get_uri("invoice_payments/credit_card_form"), "<i class='fa fa-usd'></i> " . lang('pay_with_creditcard'), array("class" => "btn btn-primary", "title" => lang('pay_with_creditcard'), "data-post-invoice_id" => $invoice_info->id)); ?>
    </div>
</div>
<div id="page-content" class="clearfix">
    ...
    <div class="m15">
        <div class="panel panel-default p15 b-t" style="max-width: 1000px; margin: auto;">
