    ...
    <div class="clearfix">
        ...
        <div class=" col-md-3 col-sm-3  form-group">
            ...
            echo form_input(array(
                "id" => "in_time",
                "name" => "in_time",
                "value" => $in_time ? convert_time_to_12hours_format(date("H:i:s", strtotime($in_time))) : "",
                "class" => "form-control",
    ...
    <div class="clearfix">
        ...
        <div class=" col-md-3 col-sm-3 form-group">
            ...
            echo form_input(array(
                "id" => "out_time",
                "name" => "out_time",
                "value" => $out_time ? convert_time_to_12hours_format(date("H:i:s", strtotime($out_time))) : "",
                "class" => "form-control",
