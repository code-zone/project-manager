...
<html lang="en">
    <head>
        ...
        <title>Quick Office - Project Manager Installation</title>
        ...
        <div class="install-box">
            ...
            <div class="panel panel-install">
                <div class="panel-heading text-center">                    
                    <h2> Quick Office - Project Manager Installation</h2>
                </div>
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed Quick Office - Project Manager</span>  
                                </div>
